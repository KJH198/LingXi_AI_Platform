...
CentOS一键启动
```
cd ./FrontEnd/lingxi_ai_platform/ && npm run build && cd ../../registerAndLogin/ && source venv/bin/activate && cd .. && nohup python3.9 ./registerAndLogin/manage.py runserver 0.0.0.0:80 &
```
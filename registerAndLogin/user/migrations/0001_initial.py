    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publishTime', models.DateTimeField(default=django.utils.timezone.now, verbose_name='发布时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(default=django.utils.timezone.now, verbose_name='最后一次看公告的时间')),
                ('last_login', models.DateTimeField(blank=True, null=True, verbose_name='最后登录时间')),
                ('online_duration', models.DurationField(default=datetime.timedelta, verbose_name='今日在线时长')),
                ('ban_type', models.CharField(blank=True, choices=[('light', '轻度违规'), ('medium', '中度违规'), ('severe', '严重违规'), ('permanent', '永久封禁')], max_length=20, null=True, verbose_name='封禁类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('followers', models.ManyToManyField(blank=True, related_name='followed_agents', to=settings.AUTH_USER_MODEL, verbose_name='关注者')),
                ('knowledge_bases', models.ManyToManyField(blank=True, to='knowledge_base.knowledgebase', verbose_name='知识库')),
                ('likes', models.ManyToManyField(blank=True, related_name='liked_agents', to=settings.AUTH_USER_MODEL, verbose_name='点赞用户')),
            ],
            options={
                'verbose_name': '已发布智能体',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('likes', models.ManyToManyField(blank=True, related_name='liked_agent_comments', to=settings.AUTH_USER_MODEL, verbose_name='点赞用户')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='user.agentcomment', verbose_name='父评论')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='agent_comments', to=settings.AUTH_USER_MODEL, verbose_name='评论者')),
                ('agent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='agent_comments', to='user.publishedagent', verbose_name='智能体')),
            ],
            options={
                'verbose_name': '智能体评论',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('login', '登录'), ('login_failed', '登录失败'), ('logout', '登出'), ('register', '注册'), ('update_profile', '更新个人信息'), ('publish_agent', '发布智能体'), ('create_agent', '创建智能体'), ('edit_agent', '编辑智能体'), ('delete_agent', '删除智能体'), ('create_post', '发帖'), ('delete_post', '删除帖'), ('edit_agent', '编辑智能体'), ('delete_agent', '删除智能体'), ('follow', '关注用户'), ('unfollow', '取消关注')], max_length=50, verbose_name='行为类型')),
                ('target_id', models.IntegerField(blank=True, null=True, verbose_name='目标ID')),
                ('target_type', models.CharField(blank=True, choices=[('agent', '智能体'), ('post', '帖子'), ('comment', '评论'), ('knowledge_base', '知识库'), ('user', '用户'), ('other', '其他')], max_length=50, null=True, verbose_name='目标类型')),
                ('ip_address', models.GenericIPAddressField(blank=True, null=True, verbose_name='IP地址')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
